...
const Footer = () => {
  return (
    <motion.div initial={{scaleY:0.4,opacity:0.5,y:80}} whileInView={{scaleY:1,opacity:1,y:0}} transition={{type:"spring",duration:0.5}} viewport={{once:true}} className='bg-white text-black pt-7 md:pt-12 px-5 md:px-16 pb-2'>
      <div className="flex md:flex-row flex-col gap-5 md:gap-3 pb-8">
        <div className=" flex flex-col gap-3 flex-[2]">
          ...
          <div className="flex gap-2">
            ...
            <a href="/" className="text-rose-600 hover:text-gray-900 dark:hover:text-rose-500">
            ...
            <a href="/" className="text-sky-500 hover:text-gray-900 dark:hover:text-sky-400">
            ...
            <a href="/" className="text-black hover:text-gray-900 dark:hover:text-black/60">
        ...
        <div className="flex flex-col gap-3 flex-[1]">
          <h1 className="font-semibold text-base">Explore</h1>
          <ul className="font-light flex flex-col gap-1">
            <li className="hover:text-black/60"><a href="/">Home</a> </li>
            <li className="hover:text-black/60"><a href="/">About</a> </li>
            <li className="hover:text-black/60"><a href="/">Category List</a> </li>
        ...
        <div className="flex flex-col gap-3 flex-[1]">
          <h1 className="font-semibold text-base">Usefull Links</h1>
          <ul className="font-light flex flex-col gap-1">
            <li className="hover:text-black/60"><a href="/">Cart</a> </li>
        ...
        <div className="flex flex-col gap-3 flex-[1]">
          ...
          <ul className="font-light flex flex-col gap-1">
            <li className="hover:text-black/60"><a href="/">Login</a> </li>
            <li className="hover:text-black/60"><a href="/">Sign Up</a> </li>
        ...
        <div className="flex flex-col gap-3 flex-[1]">
          <div>
            <h1 className="font-semibold text-base mb-2">Visit</h1>
            <p className="font-light">Avenue 1, Khayaban-e-Jinnah، Road, Johar Town, Lahore, Punjab</p>
          </div>
          <div>
      ...
      <p className="text-center font-semibold">© 2023. All Rights Reserved.</p>
