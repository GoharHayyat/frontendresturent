    ...
    <div id="slider" className="w-full h-screen relative flex overflow-hidden">
      ...
      <div
        ...
        className={`translate-x-[${
          slideIndex * -100
        }vw] flex h-full transition-all duration-1000 ease-in-out`}
      >
        {sliderItems.map((item) => (
          ...
          >
            ...
            setVariant('solid');
              ...
              <p className="my-12 mx-0 text-lg md:text-xl font-medium tracking-[3px]">
                {item.desc}
              </p>
              <button
            ...
            <div
              id="img"
              className="pb-24 md:pb-0 flex-1 h-full flex items-center justify-center relative"
            >
              <motion.img
                style={{ height: "70%" }}
      ...
      <React.Fragment>
        ...
        <Modal open={!!variant} onClose={() => setVariant(undefined)}>
          <ModalDialog variant={variant}>
            ...
            <p style={{fontSize:"12px"}}>Having trouble?</p>
            <Button onClick={handlecontinueanyway} endDecorator={<KeyboardArrowRight />} color="success">
              Continue Anyway
            </Button>
          </ModalDialog>
        </Modal>
